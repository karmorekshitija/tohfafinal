...
const schemas = {
  ...
  createProduct: Joi.object({
    ...
    category_id:                 Joi.alternatives().try(Joi.string(), Joi.number()).optional().allow(null, ''),
    subcategory_id:              Joi.alternatives().try(Joi.string(), Joi.number()).optional().allow(null, ''),
    category:                    Joi.alternatives().try(Joi.string(), Joi.number()).optional().allow(null, ''),
    ...
    photos:                      Joi.array().items(Joi.alternatives().try(Joi.string(), Joi.object())).optional(),
    ...
    occasion_tags:               Joi.array().items(Joi.string()).optional(),
