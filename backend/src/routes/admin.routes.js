...
router.post('/sellers/:id/verify', adminController.approveSeller);
router.patch('/sellers/:id/verify', adminController.approveSeller);
router.patch('/sellers/:sellerId/verify', adminController.approveSeller);
